...
#include "drivers/lcd_st7121/esp_lcd_st7121.h"
...
static m5tab5_lcd_st7121_handles_t s_handles;
...
esp_err_t m5tab5_lcd_st7121_init(m5tab5_runtime_t* runtime)
{
    ...
    esp_lcd_dsi_bus_config_t bus_cfg = ST7121_PANEL_BUS_DSI_2CH_CONFIG();
    ...
    // 5. Create the ST7121 panel / 创建 ST7121 面板
    esp_lcd_dpi_panel_config_t dpi_cfg = ST7121_720_1280_PANEL_60HZ_DPI_CONFIG(LCD_COLOR_FMT_RGB565);
    ...
    ESP_RETURN_ON_ERROR(esp_lcd_new_panel_st7121(s_handles.io, &panel_cfg, &s_handles.panel), TAG,
    ...
    ESP_LOGI(TAG, "display ready: ST7121 720x1280 MIPI-DSI");

    runtime->display_handle = &s_handles;
    return ESP_OK;
}

const m5tab5_display_driver_descriptor_t k_m5tab5_lcd_st7121_driver = {
    .id   = "m5tab5.lcd.st7121",
    .init = m5tab5_lcd_st7121_init,
};

}  // namespace

const m5tab5_display_driver_descriptor_t* m5tab5_get_lcd_st7121_driver()
{
    return &k_m5tab5_lcd_st7121_driver;
}
