...
/// Handles created by the ST7123 touch driver and stored in runtime->touch_handle.
/// ST7123 触摸驱动创建的句柄，保存�?runtime->touch_handle
/// 中�?
struct m5tab5_touch_st7123_handles_t {
