...
/// Handles created by the GT911 touch driver and stored in runtime->touch_handle.
/// GT911 触摸驱动创建的句柄，保存�?runtime->touch_handle 中�?
struct m5tab5_touch_gt911_handles_t {
